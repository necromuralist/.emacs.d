...
#+END_SRC
* Bats
  This is [[https://github.com/dougm/bats-mode][the mode]] for the [[https://github.com/bats-core/bats-core][Bash Automated Test System]].

  | Keybinding | Description                            | State           |
  |------------+----------------------------------------+-----------------|
  | C-c C-a    | Run all tests in the current directory | Working         |
  | C-c C-,    | Run all tests in the current buffer    | Working         |
  | C-c M-,    | Run test under the cursor              | [[https://github.com/sstephenson/bats/issues/36][Not Implemented]] |
